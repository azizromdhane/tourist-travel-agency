...
const DESTINATIONS = {
  paris: {
    name: 'Paris',
    mainPhoto: 'assets/img/paris.jpg',
    ...
    places: [
      { name: 'Eiffel Tower', photo: 'assets/img/paris-eiffel.jpg', desc: 'The iconic symbol of Paris, offering breathtaking views of the city.' },
      { name: 'Louvre Museum', photo: 'assets/img/paris-louvre.jpg', desc: 'The world’s largest art museum and a historic monument.' },
      { name: 'Montmartre', photo: 'assets/img/paris-montmartre.jpg', desc: 'A charming district known for its artistic history and the Sacré-Cœur.' },
    ],
    hotels: [
      { name: 'Hotel Le Meurice', photo: 'assets/img/paris-hotel1.jpg', rating: 5 },
      { name: 'Hotel Lutetia', photo: 'assets/img/paris-hotel2.jpg', rating: 5 },
      { name: 'Hotel Regina Louvre', photo: 'assets/img/paris-hotel3.jpg', rating: 4 },
    ],
  },
  london: {
    name: 'London',
    mainPhoto: 'assets/img/london.jpeg',
  ...
  dubai: {
    name: 'Dubai',
    mainPhoto: 'assets/img/dubai.jpg',
  ...
  newyork: {
    name: 'New York',
    mainPhoto: 'assets/img/new york.jpg',
  ...
  kuwait: {
    name: 'Kuwait',
    mainPhoto: 'assets/img/kuwait.jpg',
  ...
  maldives: {
    name: 'Maldives',
    mainPhoto: 'assets/img/maldives.jpg',
...
export default function Destination() {
  ...
  if (destination && DESTINATIONS[destination]) {
    ...
    return (
      <div className="container py-5">
        ...
        <img src={data.mainPhoto} alt={data.name} className="img-fluid rounded shadow mb-4 w-100" style={{ maxHeight: 400, objectFit: 'cover' }} />
        ...
        <div className="row g-4">
          {data.hotels.map((hotel, idx) => (
            <div className="col-md-4" key={idx}>
              <div className="card h-100 border-0 shadow-sm">
                <img src={hotel.photo} alt={hotel.name} className="card-img-top" style={{ height: 180, objectFit: 'cover' }} />
                <div className="card-body">
  ...
  // Sinon, liste des destinations
  return (
    <div className="container py-5">
      <h1 className="mb-4 fw-bold text-primary">Our Destinations</h1>
      <div className="row g-4">
        {Object.entries(DESTINATIONS).map(([key, dest]) => (
          <div className="col-md-4" key={key}>
            <div className="card h-100 border-0 shadow-sm">
              <img src={dest.mainPhoto} alt={dest.name} className="card-img-top" style={{ height: 180, objectFit: 'cover' }} />
              <div className="card-body text-center">
                <h5 className="card-title">{dest.name}</h5>
                <p className="card-text">{dest.description}</p>
                <Link to={`/destination/${key}`} className="btn btn-primary btn-sm mt-2">View Details</Link>
              </div>
            </div>
          </div>
        ))}
