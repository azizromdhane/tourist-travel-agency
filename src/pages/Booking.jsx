        ...
        <div className="booking p-5">
          <div className="row g-5 align-items-center">
            <div className="col-md-6 text-white">
              ...
              <p className="mb-4">
                Book your next adventure with us and enjoy seamless travel planning from start to finish.
              </p>
              <p className="mb-4">
                Our team is here to assist you with every detail, ensuring a smooth and memorable journey.
              </p>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-12">
                    <div className="form-floating">
                      <textarea
                        className="form-control bg-transparent"
                        placeholder="Let us know if you have any special requirements for your trip."
                        id="message"
                        style={{ height: 100 }}
                        defaultValue={""}
                      />
